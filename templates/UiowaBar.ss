		...
		<div class="uiowa-bar" role="region" aria-label="University of Iowa global header">
			<a href="http://www.uiowa.edu" title="The University of Iowa" class="uiowa-bar__wordmark-link">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 328.7 40.3"  class="uiowa-bar__wordmark">
					...
					<image src="uiowa-bar/images/uiowa.png" xlink:href="" alt="university of iowa logo">
					</image>
				</svg>
			</a>
			<% if $SiteConfig.QuickLinkTitleOne %>
				<div class="uiowa-bar__search">
					<ul class="uiowa-bar__links uiowa-bar__links--{$DarkLight} uiowa-bar__links--{$HeaderType}">
						<% if $SiteConfig.QuickLinkTitleOne %>
						<li class="uiowa-bar__menu-item"><a class="uiowa-bar__link uiowa-bar__link--{$DarkLight}" href="$SiteConfig.QuickLinkURLOne">$SiteConfig.QuickLinkTitleOne</a></li>
						<% end_if %>
						<% if $SiteConfig.QuickLinkTitleTwo %>
							<li class="uiowa-bar__menu-item"><a class="uiowa-bar__link uiowa-bar__link--{$DarkLight}" href="$SiteConfig.QuickLinkURLTwo">$SiteConfig.QuickLinkTitleTwo</a></li>
						<% end_if %>
						<% if $SiteConfig.QuickLinkTitleThree %>
							<li class="uiowa-bar__menu-item"><a class="uiowa-bar__link uiowa-bar__link--{$DarkLight}" href="$SiteConfig.QuickLinkURLThree">$SiteConfig.QuickLinkTitleThree</a></li>
						<% end_if %>
					</ul>
